...
{
    public class RagShot : ModProjectile
    {
        public override void SetDefaults()
        {
            projectile.width = 30; //Set the hitbox width
            projectile.height = 30; //Set the hitbox height
            projectile.timeLeft = 60*4; //The amount of time the projectile is alive for
            ...
            projectile.aiStyle = 295; // Inferno Fork Bolt

        }
        public override void AI() //Black magic don't touch
        {
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            n.AddBuff(24, 3*60); //On Fire for 3s
            owner.AddBuff(117, 3*60); //hitting an enemy with this projectile increases your damage by 10% for 3 seconds
            Main.PlaySound(SoundLoader.customSoundType, -1, -1, mod.GetSoundSlot(SoundType.Custom, "Sounds/Insects"));
